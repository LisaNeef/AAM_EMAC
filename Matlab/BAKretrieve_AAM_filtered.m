function [X,XF,MJDout] = retrieve_AAM_filtered(runid,T,filtype,fil_order,date_start,date_stop, emac_flag,no_IB)
%
...
if run_name(1:3) == 'ERA', data_type = 'RA'; end
if run_name(1:3) == 'OAM', data_type = 'RA'; end
if run_name(1:3) == 'HAM', data_type = 'RA'; end
if run_name(1:3) == 'GEO', data_type = 'GEO'; end
if run_name(1:3) == 'NET', data_type = 'GEO'; end
if run_name(1:3) == 'CAM', data_type = 'CAM'; end
