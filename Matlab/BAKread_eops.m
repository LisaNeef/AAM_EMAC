% ----read_eops.m----------------
function [X1_out,X2_out,dlod_out,mjd_out,eX1_out,eX2_out,edlod_out] = read_eops(dataset,dailyvalues)
%
...
%                ...this means that 'dataset' option is now gone.
%
%  INPUTS:
%	dataset: choose 'IERS','IERS2', or 'JPL'
%	dailyvalues: set to 1 to only choose once daily vals
%
%  OUTPUTS:
...
if dataset(1:3) == 'IER'
  ...
  if length(dataset) == 4
    ...
    disp('Reading IERS dataset 1960-2000')
  else
    ff = 'C04_1980_2010_notides.txt'
    disp('Reading IERS dataset 1980-2010')
  end
end
if dataset(1:3) == 'JPL' 
  dir = '/dsk/nathan/lisa/JPL/';
  ff = 'comb2000_1d.eop'
   d = 2;
end
